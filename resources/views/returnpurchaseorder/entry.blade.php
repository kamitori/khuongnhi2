								...
								<div class="controls">
									...
									<span>
										@foreach($users as $user)
											{{isset($returnpurchaseorder['user_id']) && ($returnpurchaseorder['user_id'] == $user['id'])?$user['name']:''}}
										@endforeach
									</span>
									@else
									...
									{{isset($returnpurchaseorder['user_id']) && ($returnpurchaseorder['user_id'] == $user['id'])?'selected':''}}
										>
											{{$user['name']}}
										</option>
										@endforeach

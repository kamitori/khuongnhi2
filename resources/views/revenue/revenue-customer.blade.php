<div class="heading-buttons main-left">
	<div class="buttons pull-left">
		...
		<a href="{{URL}}/revenues/customer-year" class="btn btn-small btn-primary btn-icon "><i class="fa fa-plus"></i> Doanh thu năm</a>
	</div>
	<div class="buttons pull-right">
		<a href="javascript:window.open('{{URL}}/revenues/export-pdf-customer','_blank');" class="btn btn-small btn-primary btn-icon "><i class="fa fa-print"></i> Xuất PDF</a>
		...
		<div class="accordion" id="accordion2" style="margin-bottom: 0;">
			<div class="accordion-group">
				<div class="accordion-heading">
					<a class="accordion-toggle">
						<strong>
							Doanh thu khách hàng <span id="company_name"></span>
						</strong>
					</a>
				</div>
				<div id="collapse1" class="accordion-body in collapse" style="height: auto;">
...
<script>
	...
	$(".left-list li").on('click',function(){
		...
		var year = $("#year").val();
		$.ajax({
			url : '{{URL}}/revenues/list-revenue-customer',
			type : 'POST',
			data :{

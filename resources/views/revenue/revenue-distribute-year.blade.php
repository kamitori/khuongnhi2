<div class="heading-buttons main-left">
	...
	<div class="buttons pull-right">
		<a href="javascript:window.open('{{URL}}/revenues/export-pdf-distribute-year','_blank');" class="btn btn-small btn-primary btn-icon "><i class="fa fa-print"></i> Xuất PDF</a>
		...
		<div class="accordion" id="accordion2" style="margin-bottom: 0;">
			<div class="accordion-group">
				<div class="accordion-heading">
					<a class="accordion-toggle">
						<strong>
							Doanh thu nhà cung cấp <span id="date_name"></span>
						</strong>
					</a>
				</div>
				<div id="collapse1" class="accordion-body in collapse" style="height: auto;">
...
<script>
	...
	$(".left-list li").on('click',function(){
		...
		current_year = year;
		$.ajax({
			url : '{{URL}}/revenues/list-revenue-distribute-year',
			type : 'POST',
			data :{
				'year' : year
			},

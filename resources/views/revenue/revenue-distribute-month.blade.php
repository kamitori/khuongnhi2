<div class="heading-buttons main-left">
	...
	<div class="buttons pull-right">
		<a href="javascript:window.open('{{URL}}/revenues/export-pdf-distribute-month','_blank');" class="btn btn-small btn-primary btn-icon "><i class="fa fa-print"></i> Xuất PDF</a>
...
<script>
	...
	$(".left-list li").on('click',function(){
		...
		current_year = year;
		$.ajax({
			url : '{{URL}}/revenues/list-revenue-distribute-month',
			type : 'POST',
			data :{
				'month' : month,
				'year' : year
